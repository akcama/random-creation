...
App at v4.0, released 2026-08-02, unchanged since. The product page is live at https://akcama.github.io/random-creation/ and is now the link to give people: it deploys from `site/` on main through its own workflow, its Download button reads the newest release from GitHub at page load, and the repository's About box points at it. The README front page has been brought to v4.0 facts. No program is in flight: what remains are the four post-release chores, in the backlog's Planned order, none of them started.
